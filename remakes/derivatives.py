...
class Paradox(Scene):
    def construct(self):
        ...
        # func = axes.plot(
        #     lambda x: 5 * np.sin(0.5 * x) + 10,
        #     x_range=[0, 10],
        #     color=BLUE
        # )

    #     func = axes.plot(
    #     lambda x: 5 * np.log(x + 1),
    #     x_range=[0, 10],
    #     color=BLUE
    # )
    #     func = axes.plot(
    ...
    # )
        ...
        self.play(x.animate.set_value(1), run_time=1)
        self.wait()
        self.play(x.animate.set_value(7), run_time=1)
        self.wait()
        self.play(dx.animate.set_value(2), run_time=2)
        self.wait()
